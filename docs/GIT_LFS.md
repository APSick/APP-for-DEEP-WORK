...
Аудиофайлы в `public/audio/` превышают лимит GitHub 100 MB. Сейчас они в `.gitignore` — в репозитории только код; файлы кладутся локально. Если нужно хранить их на GitHub, используй Git LFS:
